"""
а) Добавлен также декоратор для функции print_main_menu() line 115
б) Добавлен try/except в функцию create_file_or_directory(). Функция создает файл и папку без ошибок, если ввести имена
   и файла и папки. Создает также файл или папку по отдельности, если вводить имя или файла или только папки. До записи с
   помощью try/except была красная ошибка. Понятно, что можно разделить функцию на две и не будет никаких ошибок. Но было
   интересно заставить код работать при условии 2 в одном.
"""
